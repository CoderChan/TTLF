...
{
    static NSString *ID = @"HorizontalCollectionCell";
    HorizontalCollectionCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
    if (!cell) {
        cell = [[HorizontalCollectionCell alloc]init];
    }
    return cell;
}
...
- (void)setupSubViews
{
    ...
    // 佛像图
    self.pusaImgView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"gy_释迦牟尼佛"]];
