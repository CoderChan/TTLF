...
//        UIImageView *bigImgView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
//        bigImgView.userInteractionEnabled = YES;
//        bigImgView.contentMode = UIViewContentModeScaleAspectFit;
//        bigImgView.image = self.commentImgView.image;
//        [keyWindow addSubview:bigImgView];
//        
...
//        deleteBtn.frame = CGRectMake(bigImgView.width - 70, 44, 40, 40);
//        [deleteBtn setTitle:@"删除" forState:UIControlStateNormal];
//        [bigImgView addSubview:deleteBtn];
//        
//        
//        UITapGestureRecognizer *missTap = [[UITapGestureRecognizer alloc]initWithActionBlock:^(id  _Nonnull sender) {
//            [bigImgView removeFromSuperview];
//        }];
//        [bigImgView addGestureRecognizer:missTap];
//        
        
    }];
    [self.commentImgView addGestureRecognizer:iconTap];
