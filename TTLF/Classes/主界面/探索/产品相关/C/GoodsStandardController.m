...
@interface GoodsStandardController ()<UIWebViewDelegate>
{
    BOOL theBool;
...

{
    ...
    topLabel.text = self.model.goods_name;
    ...
    bottomLabel.text = self.model.goods_name;
