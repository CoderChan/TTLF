 ...
 * @see registerApp
 * 参数 typeFlag 应用支持打开的数据类型, enAppSupportContentFlag枚举类型 “|” 操作后结果
 */
 ...
 * 参数 url 微信启动第三方应用时传递过来的URL
 * 参数 delegate  WXApiDelegate对象，用来接收微信触发的消息。
 * @return 成功返回YES，失败返回NO。
 */
