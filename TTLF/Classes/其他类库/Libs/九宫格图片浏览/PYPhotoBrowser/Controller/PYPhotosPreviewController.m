...
+ (instancetype)previewController
{
    ...
    readerVc.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"dismiss"] style:UIBarButtonItemStylePlain target:readerVc action:@selector(backAction)];
    readerVc.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"rightbar_more"] style:UIBarButtonItemStylePlain target:readerVc action:@selector(trashDidClicked)];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    contentScrollView.height = contentScrollView.height > PYScreenH ? PYScreenH : contentScrollView.height;
