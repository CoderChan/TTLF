...
- (void)saveUserInfo:(UserInfoModel *)userModel Success:(void (^)())success Fail:(FailBlock)fail
{
    ...
    [UD setObject:[NSString stringWithFormat:@"%d",userModel.isOutHome] forKey:UisOutHome];
    ...
    [UD setObject:[NSString stringWithFormat:@"%d",userModel.sex] forKey:Usex];
    [UD setObject:[NSString stringWithFormat:@"%g",userModel.punnaNum] forKey:UpunnaNum];
    [UD setObject:userModel.headUrl forKey:UheadUrl];
    [UD setObject:[NSString stringWithFormat:@"%@",userModel.register_time] forKey:UregisterTime];
...
- (UserInfoModel *)getUserInfo
{
    ...
    BOOL isOutHome = [[UD objectForKey:UisOutHome] boolValue];
    ...
    int sex = [[UD objectForKey:Usex] intValue];
    float punnaNum = [[UD objectForKey:UpunnaNum] floatValue];
